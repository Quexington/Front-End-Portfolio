...
const actionCreators = {
  changeSearch: function(value, timer){
    return function(dispatch){
      ...
      dispatch({
        type: ACTIONS.HANDLE_NEW_POST_INPUT_CHANGE,
        value,
      });
      dispatch({
...
"title": "Bounce Back",
          ...
          dispatch({
            type: ACTIONS.SET_NEW_POST_SEARCH_RESULTS,
            results,
          });
          dispatch({
            type: ACTIONS.TOGGLE_SOCIAL_LOADING,
          ...
          dispatch({
            type: ACTIONS.SET_NEW_POST_SEARCH_TIMER_ID,
            id: "0",
          });
        },50);
      },500);
  ...
  toggleVisibility: function(hidden){
    return function(dispatch){
      dispatch({
        type: ACTIONS.TOGGLE_NEW_POST_RESULTS_HIDDEN,
        hidden,
      });
    }
  }
